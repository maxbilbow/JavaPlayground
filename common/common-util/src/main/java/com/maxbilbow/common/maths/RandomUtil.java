...
public class RandomUtil
{
  ...
  private static <N extends Number> N convert(Number aNumber, Class<N> aClass)
  {
    ...
    catch (ObjectConversionException aE)
    {
  ...
  {
    @SuppressWarnings("unchecked") final Class<N> nClass = (Class<N>) aMax.getClass();
